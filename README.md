...
# Master in Mathematical Engineering (UCM 2025-26)

Central repository for the MSc in Mathematical Engineering (UCM 2025-26), compiling coursework, projects, and exercises in scientific computing, numerical analysis, and mathematical modeling. This repository showcases technical skills and problem-solving abilities developed throughout the program, preparing for advanced STEM roles, data science, analytics, and research-industry applications.

**Plan of Studies:** [UCM MSc in Mathematical Engineering](https://www.ucm.es/estudios/2024-25/master-ingenieriamatematica-plan)
...
│ └── Supplementary-Projects/ <-- Other Important Projects
│ ├── README.md
│ ├── Code/
│ └── Data/
